...
ioncore.exec("wicd-client & klipper & xfce4-terminal & firefox & kopete & docker")
--ioncore.exec("xrandr --output VGA --mode 1024x768 --pos 0x0  --output LVDS --mode 1280x800 --pos 0x768")
ioncore.exec("xrandr --output VGA --rate 75 --mode 1440x900 --pos 0x0  --output LVDS --mode 1280x800 --pos 0x900")
--ioncore.exec("xrandr  --output LVDS --mode 1280x800 --pos 0x0 --output VGA --rate 75 --mode 1440x900 --pos 0x800 ")
