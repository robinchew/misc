...
defbindings("WScreen", {
    ...
    kpress(META.."Tab", "ioncore.goto_next(_chld, 'right')", 
           "_chld:non-nil"),
    kpress(META.."u", "ioncore.goto_next(_chld, 'right')", 
           "_chld:non-nil"),
    kpress(META.."o", "ioncore.goto_next(_chld, 'left')", 

           "_chld:non-nil"),
    kpress(META.."period", "ioncore.goto_next(_chld, 'up')", 
           "_chld:non-nil"),
    kpress(META.."e", "ioncore.goto_next(_chld, 'down')", 
           "_chld:non-nil"),
...
defbindings("WMPlex.toplevel", {
    ...
    bdoc("Run a terminal emulator."),
    kpress(META.."Control+t", "ioncore.exec_on(_, XTERM or 'x-terminal-emulator')"),

    --robin
    kpress(META.."Control+h", "ioncore.exec_on(_, 'dolphin')"),
    kpress(META.."Control+Home", "ioncore.exec_on(_, 'dolphin')"),

    --sound
    kpress("XF86AudioRaiseVolume", "ioncore.exec_on(_, 'amixer set Master 10%+')"),
    kpress("XF86AudioLowerVolume", "ioncore.exec_on(_, 'amixer set Master 10%-')"),
...
defbindings("WFrame.toplevel", {
    ...
    kpress(META.."Tab", "mod_query.query_attachclient(_)"),
