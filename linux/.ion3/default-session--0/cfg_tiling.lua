...
defbindings("WTiling", {
    ...
    --USING ARROW KEYS
        ...
        bdoc("Split current frame vertically."),
        kpress("Up", "WTiling.split_at(_, _sub, 'up', false)"),

        bdoc("Split current frame vertically."),
        kpress("Down", "WTiling.split_at(_, _sub, 'down', false)"),

    --USING LEFT KEYBOARD
--        bdoc("Split current frame horizontally."),
--        kpress("u", "WTiling.split_at(_, _sub, 'left', true)"),
--
--        bdoc("Split current frame horizontally."),
--        kpress("o", "WTiling.split_at(_, _sub, 'right', true)"),
--
--        bdoc("Split current frame vertically."),
--        kpress("period", "WTiling.split_at(_, _sub, 'down', true)"),
--
--        bdoc("Split current frame vertically."),
--        kpress("e", "WTiling.split_at(_, _sub, 'up', true)"),
--
        bdoc("Split current frame horizontally."),
        kpress("u", "WTiling.split_at(_, _sub, 'right', false)"),

        bdoc("Split current frame horizontally."),
        kpress("o", "WTiling.split_at(_, _sub, 'left', false)"),

        bdoc("Split current frame vertically."),
        kpress("period", "WTiling.split_at(_, _sub, 'up', false)"),

        bdoc("Split current frame vertically."),
        kpress("e", "WTiling.split_at(_, _sub, 'down', false)"),
    }),
})
