...
-- Load someone's keybind
-- http://git.ierton.homelinux.net/?p=awesomerc;a=tree
...
for s = 1, screen.count() do
    ...
    mypromptbox[s] = awful.widget.prompt({ align = "right" })
...
--table.insert(keybind_ctrl_f, awful.key({}, "a", function () 
--    mytextbox.text = "You pressed a!"
--    keychain_ctrl_f_remove() 
--end)) 
--
--table.insert(keybind_ctrl_f, awful.key({ "Mod4" }, "b", function () 
--    mytextbox.text = "You pressed Mod4 + b!"
--    keychain_ctrl_f_remove() 
--end)) 
--
--table.insert(keybind_ctrl_f, awful.key({}, "Escape", keychain_ctrl_f_remove)) 
tagkeys = {
}
--GET THIS BACK
...
--            myrc.keybind.key({}, "b", "Test action", function(c)
...
for i = 1, keynumber do
    globalkeys = awful.util.table.join(globalkeys,
        ...
        awful.key({ modkey, "Shift", "Control" }, i,
                  function ()
                      if client.focus and tags[client.focus.screen][i] then
                          awful.client.toggletag(tags[client.focus.screen][i])
                      end
                  end),
        awful.key({ modkey, "Shift", "Control" },'F' ..  i,
                  function ()
                      local screen = mouse.screen
                      if tags[screen][i] then
                          for k, c in pairs(awful.client.getmarked()) do
